                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="exam_id" required id="exam_id" class="form-control select2"
                                                disabled>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="number" required class="radmin-input points" disabled
                                                       ...
                                                       max="{{ $max }}">
                                                <strong>%</strong>
                                                <input type="hidden" id="learner_id_{{ $key }}"
                                                       value="{{ $learner->id }}">
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <button type="button" id="learner_save_btn_{{ $learner->id }}" disabled
                                                    class="btn btn-success btn-rounded summative-save"
                                                    data-key="{{ $key }}"
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body p-5 text-center">
                            <h5>{{ __('Please contact admin for activate summative assessments') }}</h5>
                        </div>
                    </div>
                </div>
            </div>
