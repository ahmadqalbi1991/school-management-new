            ...
            <div class="col-xl-3 col-md-6">
                <div class="card card-green text-white">
                    <div class="card-block">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h4 class="mb-0">{{ $formative_assessments->count() }}</h4>
                                <p class="mb-0">{{ __('Formative Assessments')}}</p>
                            </div>
                            <div class="col-4 text-right">
                                <i class="fas fa-sticky-note f-30"></i>
                            </div>
                        </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card card-yellow text-white">
                    <div class="card-block">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h4 class="mb-0">{{ $summative_assessments->count() }}</h4>
                                <p class="mb-0">{{ __('Summative Assessments')}}</p>
                            </div>
                            <div class="col-4 text-right">
